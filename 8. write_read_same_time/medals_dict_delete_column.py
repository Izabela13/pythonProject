...
Chcemy usunąć, np. kraj. Nie możemy usunąć 'country' ze zmiennej 'column_names'. Dostaniemy exception. 
DictWriter będzie wychwytywał 'country' w tabeli, a nie będzie wiedział, co z tym zrobić. Natrafiając na taki header
DictWriter nie będzie wiedział, gdzie wstawić 'country'. 

Nazwy kolumn można ekstrachować. W tym celu trzeba wprowadzić dodatkowy argument (poinformować DictWritera):
    extrasaction='ignore'
"""
...
"""
Gdy teraz usuniemy 'country' z listy nazw kolumn, DictWriter pominie tę daną. 
"""